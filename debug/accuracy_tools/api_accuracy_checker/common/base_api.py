...
class BaseAPIInfo:
    ...
    def analyze_tensor(self, arg):
        ...
        if not self.is_save_data:
            ...
            if self.is_forward:
                forward_real_data_path = os.path.join(self.save_path, self.forward_path, "step" + str(DumpUtil.call_num), "rank" + str(self.rank))
                ...
                backward_real_data_path = os.path.join(self.save_path, self.backward_path, "step" + str(DumpUtil.call_num), "rank" + str(self.rank))
